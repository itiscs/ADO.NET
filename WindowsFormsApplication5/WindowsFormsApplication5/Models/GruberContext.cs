...
namespace WindowsFormsApplication5.Models
{
    public class GruberContextInitializer : DropCreateDatabaseAlways<GruberContext>
    {
        protected override void Seed(GruberContext context)
        {
            ...
            //****************** SALESPEOPLE ***********************
            context.Salespeople.Add(new Salesperson()
            {
                Snum = 1001,
                Sname = "Peel",
                City = "London",
            ...
            context.SaveChanges();
           // context.Salespeople.SqlQuery("se")
    ...
    public class GruberContext:DbContext
    {
        ...
        public GruberContext() : base("EntityGruber")
        {
        ...
        {
            modelBuilder.Entity<Salesperson>().Property(s => s.Comm).HasPrecision(3, 2);
        }
